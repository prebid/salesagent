...
- **MOVED to PR 3 (P0 sweep): Gemini fallback fix** (`test.yml:342`) — PR 3 rewrites test.yml wholesale; the fix lands in `_pytest/action.yml`'s env block as part of PR 3's commit sequence.
