...
|---|---|---|---|---|
| **Week 0 (pre-flight)** | — | — | A1-A10, P1-P6 | snapshot branch protection, capture baselines, enable Dependabot+CodeQL Advanced |
...
| **Week 6 (slack)** | PR 6 (optional) | PR 6 if greenlit | D-pending-4 resolved | final OpenSSF Scorecard ≥ 7.5; close #1234 |

### Dependency graph

```
[Pre-flight A1-A10 + P1-P6]
        │
        ▼
...
[PR 3 Phase C] ──── delete test.yml (≥48h after Phase B stable)
    ...
    [PR 4] ───── delete absorbed hooks; warm latency 23s → ~1.7s
        │
        ▼
    [PR 5] ───── version anchor consolidation; py312 target bumps
        │
        ▼
