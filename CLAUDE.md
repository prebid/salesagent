...
| AdCP schema cache complete | Local `schemas/<version>/` cache contains the transitive closure of every `$ref` declared in `index.json` | `test_architecture_adcp_schema_cache_complete.py` |
