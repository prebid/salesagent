...
**Spec:** AdCP 3.0.1 `core/targeting.json:189-200`; storyboard `inventory_list_targeting`
**Business Rule:** BR-RULE-014
**Priority:** P1
...
**Spec:** AdCP 3.0.1 `core/targeting.json:191` ("Sellers SHOULD return a validation error if the product has property_targeting_allowed: false")
**Business Rule:** BR-RULE-014
**Priority:** P1
