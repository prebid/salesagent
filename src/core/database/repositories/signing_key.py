...
Three selectors, and the differences matter:
...
* :meth:`all_revoked` — the PERMANENT revocation record, with no grace cutoff
  at all, because a kid dropped from that list is a kid un-revoked.
"""
