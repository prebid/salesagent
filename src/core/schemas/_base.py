...
from adcp.types.generated_poc.enums.media_buy_valid_action import (
    MediaBuyValidAction,  # TODO: no stable alias in adcp.types
)
...
from adcp.types.generated_poc.core.property import (
    Identifier as PropertySpecificIdentifier,  # TODO: no stable alias in adcp.types (different from adcp.types.Identifier)
)
