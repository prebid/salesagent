            ...
            try:
                ...
                if buy.raw_request and isinstance(buy.raw_request, dict):
                    ...
                    for pkg_data in packages:
                        ...
                        placement_dim = (
                            req.reporting_dimensions.placement if req.reporting_dimensions else None
                        )
                        if placement_dim is not None and raw_placements:
                            ...
                            sort_metric = (
                                str(placement_dim.sort_by) if hasattr(placement_dim, "sort_by") and placement_dim.sort_by else "spend"
                            )
