...
from src.core.exceptions import AdCPAdapterError, AdCPAuthenticationError, AdCPError, AdCPValidationError
            ...
            for requested_id in req.media_buy_ids:
                if requested_id not in found_ids:
                    not_found_errors.append(
                        Error(  # noqa: structural-guard — advisory per-buy result in GetMediaBuyDeliveryResponse.errors[]
