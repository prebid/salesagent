...
Feature: BR-ADMIN-ACCOUNTS Admin Account Management
  ...
  @T-ADMIN-ACCT-001 @list @main-flow @pending
  ...
  @T-ADMIN-ACCT-002 @create @main-flow @pending
  ...
  @T-ADMIN-ACCT-003 @detail @main-flow @pending
  ...
  @T-ADMIN-ACCT-004 @edit @main-flow @pending
  ...
  @T-ADMIN-ACCT-005 @status @main-flow @pending
  ...
  @T-ADMIN-ACCT-006 @status @validation @edge-case @pending
  ...
  @T-ADMIN-ACCT-007 @filter @alternative @pending
  ...
  @T-ADMIN-ACCT-008 @validation @create @edge-case @pending
  ...
  @T-ADMIN-ACCT-009 @auth @edge-case @pending
  ...
  @T-ADMIN-ACCT-010 @status @detail @edge-case @pending
