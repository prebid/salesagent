...
Feature: BR-UC-007 Discover Publisher Properties
  ...
  @T-UC-007-main-rest @main-flow @rest @post-s1 @post-s2 @post-s3 @post-s4 @post-s6 @pending
  ...
  @T-UC-007-main-mcp @main-flow @mcp @post-s1 @post-s2 @post-s3 @post-s4 @post-s6 @pending
  ...
  @T-UC-007-main-policy @main-flow @post-s5 @pending
  ...
  @T-UC-007-main-context @main-flow @post-s7 @pending
  ...
  @T-UC-007-audit-log @main-flow @audit @pending
  ...
  @T-UC-007-ext-a-rest @extension @ext-a @error @rest @post-f1 @post-f2 @pending
  ...
  @T-UC-007-ext-a-mcp @extension @ext-a @error @mcp @post-f1 @post-f2 @pending
  ...
  @T-UC-007-ext-b-rest @extension @ext-b @error @rest @post-f1 @post-f2 @pending
  ...
  @T-UC-007-ext-b-mcp @extension @ext-b @error @mcp @post-f1 @post-f2 @pending
  ...
  @T-UC-007-audit-log-error @extension @ext-b @audit @pending
  ...
  @T-UC-007-ext-c-rest @extension @ext-c @error @rest @post-f1 @post-f2 @pending
  ...
  @T-UC-007-ext-c-mcp @extension @ext-c @error @mcp @post-f1 @post-f2 @pending
  ...
  @T-UC-007-error-context-echo @extension @error @context-echo @post-f3 @pending
  ...
  @T-UC-007-r041-inv1-holds @invariant @BR-RULE-041 @authentication @pending
  ...
  @T-UC-007-r041-inv2-holds @invariant @BR-RULE-041 @authentication @pending
  ...
  @T-UC-007-r041-inv3-holds @invariant @BR-RULE-041 @authentication @mcp @pending
  ...
  @T-UC-007-r041-inv5-holds @invariant @BR-RULE-041 @authentication @rest @pending
  ...
  @T-UC-007-r041-inv4-holds @invariant @BR-RULE-041 @authentication @mcp @pending
  ...
  @T-UC-007-r042-inv1-holds @invariant @BR-RULE-042 @portfolio @pending
  ...
  @T-UC-007-r042-inv2-holds @invariant @BR-RULE-042 @portfolio @pending
  ...
  @T-UC-007-r042-inv3-holds @invariant @BR-RULE-042 @portfolio @pending
  ...
  @T-UC-007-r043-inv1-holds @invariant @BR-RULE-043 @context-echo @pending
  ...
  @T-UC-007-r043-inv2-holds @invariant @BR-RULE-043 @context-echo @pending
  ...
  @T-UC-007-r044-inv1-holds @invariant @BR-RULE-044 @advertising-policy @pending
  ...
  @T-UC-007-r044-inv2-holds @invariant @BR-RULE-044 @advertising-policy @pending
  ...
  @T-UC-007-r044-inv3-holds @invariant @BR-RULE-044 @advertising-policy @pending
  ...
  @T-UC-007-r044-inv4-holds @invariant @BR-RULE-044 @advertising-policy @pending
  ...
  @T-UC-007-r044-partial-categories @invariant @BR-RULE-044 @advertising-policy @pending
  ...
  @T-UC-007-r044-blocked-advertisers @invariant @BR-RULE-044 @advertising-policy @pending
  ...
  @T-UC-007-r045-inv1-holds @invariant @BR-RULE-045 @domain-filter @pending
  ...
  @T-UC-007-r045-inv4-holds @invariant @BR-RULE-045 @domain-filter @pending
  ...
  @T-UC-007-domain-format @validation @domain-filter @partition @pending
  ...
  @T-UC-007-partition-context @partition @context-echo @pending
  ...
  @T-UC-007-partition-portfolio @partition @portfolio @pending
  ...
  @T-UC-007-partition-policy @partition @advertising-policy @pending
  ...
  @T-UC-007-partition-auth @partition @authentication @pending
  ...
  @T-UC-007-partition-auth-a2a @partition @authentication @rest @pending
  ...
  @T-UC-007-partition-filter-extra @partition @domain-filter @pending
  ...
  @T-UC-007-partition-filter-multi @partition @domain-filter @pending
  ...
  @T-UC-007-partition-filter-empty @partition @domain-filter @pending
  ...
  @T-UC-007-filter-match @domain-filter @filtering @pending
  ...
  @T-UC-007-filter-partial @domain-filter @filtering @pending
  ...
  @T-UC-007-boundary-context @boundary @context-echo @pending
  ...
  @T-UC-007-boundary-publishers @boundary @portfolio @pending
  ...
  @T-UC-007-boundary-publishers-1 @boundary @portfolio @pending
  ...
  @T-UC-007-boundary-publishers-large @boundary @portfolio @pending
  ...
  @T-UC-007-boundary-publishers-mixed @boundary @portfolio @pending
  ...
  @T-UC-007-boundary-policy-disabled @boundary @advertising-policy @pending
  ...
  @T-UC-007-boundary-policy @boundary @advertising-policy @pending
  ...
  @T-UC-007-boundary-domain-filter @boundary @domain-filter @pending
  ...
  @T-UC-007-boundary-domain-filter-one @boundary @domain-filter @pending
  ...
  @T-UC-007-boundary-domain-filter-empty @boundary @domain-filter @pending
  Scenario: Publisher domain filter boundary - 0 domains (empty array)
    When the Buyer Agent requests list_authorized_properties with publisher_domains filter []
    Then the request should be rejected with schema validation error
    # Boundary: 0 domains (empty array) -> minItems:1 violated

  @T-UC-007-boundary-domain-filter-minimal @boundary @domain-filter @pending
  ...
  @T-UC-007-boundary-domain-filter-uppercase @boundary @domain-filter @pending
  Scenario: Publisher domain filter boundary - domain 'A'
    When the Buyer Agent requests list_authorized_properties with publisher_domains filter ["A"]
    Then the request should be rejected with error "DOMAIN_INVALID_FORMAT"
    # Boundary: domain 'A' -> uppercase rejected by pattern

  @T-UC-007-boundary-domain-filter-hyphen @boundary @domain-filter @pending
  ...
  @T-UC-007-boundary-auth @boundary @authentication @pending
  ...
  @T-UC-007-boundary-auth-valid @boundary @authentication @pending
  ...
  @T-UC-007-boundary-auth-expired @boundary @authentication @mcp @pending
  ...
  @T-UC-007-boundary-auth-malformed @boundary @authentication @mcp @pending
  ...
  @T-UC-007-boundary-auth-a2a-invalid @boundary @authentication @rest @pending
  ...
  @T-UC-007-enum-creatives-fields @validation @list-creatives-fields @partition @boundary @pending
  ...
  @T-UC-007-enum-sort-field @validation @creative-sort-field @partition @boundary @pending
  ...
  @T-UC-007-enum-preview-format @validation @preview-output-format @partition @boundary @pending
  ...
  @T-UC-007-boundary-property-type @boundary @property-type @partition @pending
