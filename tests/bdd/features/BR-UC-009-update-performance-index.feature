...
Feature: BR-UC-009 Update Performance Index
  ...
  @T-UC-009-main-mcp @main-flow @mcp @pending
  ...
  @T-UC-009-main-mcp-adapter @main-flow @mcp @adapter @pending
  ...
  @T-UC-009-main-mcp-audit @main-flow @mcp @audit @pending
  ...
  @T-UC-009-main-rest @main-flow @rest @a2a @pending
  ...
  @T-UC-009-main-rest-adapter @main-flow @rest @adapter @pending
  ...
  @T-UC-009-batch @main-flow @batch @pending
  ...
  @T-UC-009-single @main-flow @batch @pending
  ...
  @T-UC-009-idempotent @main-flow @idempotent @pending
  ...
  @T-UC-009-inv-018-1 @invariant @BR-RULE-018 @pending
  ...
  @T-UC-009-inv-018-2 @invariant @BR-RULE-018 @error @pending
  ...
  @T-UC-009-inv-021-1 @invariant @BR-RULE-021 @pending
  ...
  @T-UC-009-inv-021-1-buyerref @invariant @BR-RULE-021 @pending
  ...
  @T-UC-009-inv-021-2 @invariant @BR-RULE-021 @error @pending
  ...
  @T-UC-009-inv-021-3 @invariant @BR-RULE-021 @error @pending
  ...
  @T-UC-009-inv-043-1 @invariant @BR-RULE-043 @context @pending
  ...
  @T-UC-009-inv-043-2 @invariant @BR-RULE-043 @context @pending
  ...
  @T-UC-009-inv-043-err @invariant @BR-RULE-043 @context @error @pending
  ...
  @T-UC-009-perf-index @validation @performance-index @partition @boundary @invariant @BR-RULE-051 @pending
  ...
  @T-UC-009-meas-period @validation @measurement-period @partition @boundary @pending
  ...
  @T-UC-009-metric-type @validation @metric-type @partition @boundary @pending
  ...
  @T-UC-009-fb-source @validation @feedback-source @partition @boundary @pending
  ...
  @T-UC-009-pkg-id @validation @package-id @partition @boundary @pending
  ...
  @T-UC-009-creative-id @validation @creative-id @partition @boundary @pending
  ...
  @T-UC-009-mb-ident @validation @media-buy-identification @partition @boundary @BR-RULE-021 @pending
  ...
  @T-UC-009-granularity @dependency @granularity @pending
  ...
  @T-UC-009-ext-a-mcp @extension @ext-a @error @mcp @pending
  ...
  @T-UC-009-ext-a-rest @extension @ext-a @error @rest @pending
  ...
  @T-UC-009-ext-b-mcp @extension @ext-b @error @mcp @validation @pending
  ...
  @T-UC-009-ext-b-mcp-empty @extension @ext-b @error @mcp @validation @pending
  ...
  @T-UC-009-ext-b-rest @extension @ext-b @error @rest @validation @pending
  ...
  @T-UC-009-ext-b-rest-pydantic @extension @ext-b @error @rest @validation @pending
  ...
  @T-UC-009-ext-b-type @extension @ext-b @error @validation @pending
  ...
  @T-UC-009-ext-c-noauth @extension @ext-c @error @auth @mcp @pending
  ...
  @T-UC-009-ext-c-ownership @extension @ext-c @error @auth @pending
  ...
  @T-UC-009-ext-c-principal @extension @ext-c @error @auth @pending
  ...
  @T-UC-009-ext-c-a2a-auth @extension @ext-c @error @auth @rest @pending
  ...
  @T-UC-009-ext-d-false @extension @ext-d @error @adapter @pending
  ...
  @T-UC-009-ext-d-exception @extension @ext-d @error @adapter @rest @pending
  ...
  @T-UC-009-sandbox-happy @invariant @br-rule-209 @sandbox @pending
  ...
  @T-UC-009-sandbox-production @invariant @br-rule-209 @sandbox @pending
  ...
  @T-UC-009-sandbox-validation @invariant @br-rule-209 @sandbox @pending
