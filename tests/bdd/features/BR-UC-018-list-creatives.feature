...
Feature: BR-UC-018 List Creatives
  ...
  @T-UC-018-main @main-flow @pending
  ...
  @T-UC-018-main-enriched @main-flow @pending
  ...
  @T-UC-018-main-performance @main-flow @pending
  ...
  @T-UC-018-main-subassets @main-flow @pending
  ...
  @T-UC-018-ext-a @extension @ext-a @error @pending
  ...
  @T-UC-018-ext-b @extension @ext-b @error @pending
  ...
  @T-UC-018-ext-c @extension @ext-c @error @pending
  ...
  @T-UC-018-ext-d @extension @ext-d @error @pending
  ...
  @T-UC-018-partition-default-query @partition @default-query-behavior @pending
  ...
  @T-UC-018-boundary-default-query @boundary @default-query-behavior @pending
  ...
  @T-UC-018-partition-pagination @partition @pagination-sorting @pending
  ...
  @T-UC-018-boundary-pagination @boundary @pagination-sorting @pending
  ...
  @T-UC-018-partition-filters @partition @filter-semantics @pending
  ...
  @T-UC-018-boundary-filters @boundary @filter-semantics @pending
  ...
  @T-UC-018-partition-field-selector @partition @field-selector @pending
  ...
  @T-UC-018-boundary-field-selector @boundary @field-selector @pending
  ...
  @T-UC-018-inv-146-1-holds @invariant @BR-RULE-146 @pending
  ...
  @T-UC-018-inv-146-2-holds @invariant @BR-RULE-146 @pending
  ...
  @T-UC-018-inv-146-2-violated @invariant @BR-RULE-146 @pending
  ...
  @T-UC-018-inv-146-3-holds @invariant @BR-RULE-146 @pending
  ...
  @T-UC-018-inv-147-1-holds @invariant @BR-RULE-147 @pending
  ...
  @T-UC-018-inv-147-2-holds @invariant @BR-RULE-147 @pending
  ...
  @T-UC-018-inv-147-3-holds @invariant @BR-RULE-147 @pending
  ...
  @T-UC-018-inv-147-4-holds @invariant @BR-RULE-147 @pending
  ...
  @T-UC-018-inv-147-5-holds @invariant @BR-RULE-147 @pending
  ...
  @T-UC-018-inv-148-1-holds @invariant @BR-RULE-148 @pending
  ...
  @T-UC-018-inv-148-1-violated @invariant @BR-RULE-148 @pending
  ...
  @T-UC-018-inv-148-2-holds @invariant @BR-RULE-148 @pending
  ...
  @T-UC-018-inv-148-2-violated @invariant @BR-RULE-148 @pending
  ...
  @T-UC-018-inv-148-3-holds @invariant @BR-RULE-148 @pending
  ...
  @T-UC-018-inv-148-4-holds @invariant @BR-RULE-148 @pending
  ...
  @T-UC-018-inv-148-5-holds @invariant @BR-RULE-148 @pending
  ...
  @T-UC-018-inv-148-6-holds @invariant @BR-RULE-148 @pending
  ...
  @T-UC-018-inv-148-6-violated @invariant @BR-RULE-148 @pending
  ...
  @T-UC-018-inv-149-1-holds @invariant @BR-RULE-149 @pending
  ...
  @T-UC-018-inv-149-2-holds @invariant @BR-RULE-149 @pending
  ...
  @T-UC-018-inv-149-3-holds @invariant @BR-RULE-149 @pending
  ...
  @T-UC-018-inv-149-4-holds @invariant @BR-RULE-149 @pending
  ...
  @T-UC-018-inv-149-5-holds @invariant @BR-RULE-149 @pending
  ...
  @T-UC-018-inv-149-6-holds @invariant @BR-RULE-149 @pending
  ...
  @T-UC-018-inv-034-1-holds @invariant @BR-RULE-034 @pending
  ...
  @T-UC-018-inv-034-1-violated @invariant @BR-RULE-034 @pending
  ...
  @T-UC-018-edge-empty-library @main-flow @edge-case @pending
  ...
  @T-UC-018-edge-pagination-next @main-flow @edge-case @pending
  ...
  @T-UC-018-edge-duplicate-dedup @invariant @BR-RULE-148 @edge-case @pending
  ...
  @T-UC-018-edge-valid-date @main-flow @edge-case @pending
  ...
  @T-UC-018-partition-legacy-fields @partition @list-creatives-fields @pending
  ...
  @T-UC-018-partition-sort-field @partition @creative-sort-field @pending
  ...
  @T-UC-018-boundary-legacy-fields @boundary @list-creatives-fields @pending
  ...
  @T-UC-018-boundary-sort-field @boundary @creative-sort-field @pending
  ...
  @T-UC-018-sandbox-happy @invariant @br-rule-209 @sandbox @pending
  ...
  @T-UC-018-sandbox-production @invariant @br-rule-209 @sandbox @pending
  ...
  @T-UC-018-sandbox-validation @invariant @br-rule-209 @sandbox @pending
