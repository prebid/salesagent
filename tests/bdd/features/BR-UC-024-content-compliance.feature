...
Feature: BR-UC-024 Content Compliance
  ...
  @T-UC-024-main-mcp @main-flow @get-artifacts @mcp @post-s2 @post-s5 @post-s6 @pending
  ...
  @T-UC-024-main-rest @main-flow @get-artifacts @rest @post-s2 @post-s5 @post-s6 @pending
  ...
  @T-UC-024-main-drift @main-flow @get-artifacts @drift-detection @post-s4 @pending
  ...
  @T-UC-024-main-no-local @main-flow @get-artifacts @drift-detection @post-s4 @pending
  ...
  @T-UC-024-main-filters @main-flow @get-artifacts @filtering @pending
  ...
  @T-UC-024-main-pagination-cursor @main-flow @get-artifacts @pagination @pending
  ...
  @T-UC-024-ext-a-pass @extension @ext-a @calibration @happy-path @post-s1 @post-s5 @pending
  ...
  @T-UC-024-ext-a-fail @extension @ext-a @calibration @happy-path @post-s1 @pending
  ...
  @T-UC-024-ext-a-dialogue @extension @ext-a @calibration @dialogue @happy-path @post-s1 @pending
  ...
  @T-UC-024-ext-a-question @extension @ext-a @calibration @dialogue @happy-path @pending
  ...
  @T-UC-024-ext-a-async @extension @ext-a @calibration @dialogue @async @pending
  ...
  @T-UC-024-ext-b-success @extension @ext-b @validation @happy-path @post-s3 @post-s5 @pending
  ...
  @T-UC-024-ext-b-features @extension @ext-b @validation @feature-filtering @happy-path @post-s3 @pending
  ...
  @T-UC-024-ext-b-include-passed-false @extension @ext-b @validation @result-filtering @happy-path @post-s3 @pending
  ...
  @T-UC-024-ext-b-drift @extension @ext-b @validation @drift-detection @happy-path @post-s4 @pending
  ...
  @T-UC-024-ext-b-all-features @extension @ext-b @validation @feature-filtering @happy-path @pending
  ...
  @T-UC-024-ext-b-include-passed-default @extension @ext-b @validation @result-filtering @happy-path @pending
  ...
  @T-UC-024-ext-c-calibrate @extension @ext-c @error @standards-not-found @pending
  ...
  @T-UC-024-ext-c-validate @extension @ext-c @error @standards-not-found @pending
  ...
  @T-UC-024-ext-d-mcp @extension @ext-d @error @media-buy-not-found @pending
  ...
  @T-UC-024-ext-d-rest @extension @ext-d @error @media-buy-not-found @pending
  ...
  @T-UC-024-ext-e-empty @extension @ext-e @error @records-required @pending
  ...
  @T-UC-024-ext-e-absent @extension @ext-e @error @records-required @pending
  ...
  @T-UC-024-ext-f @extension @ext-f @error @records-limit-exceeded @pending
  ...
  @T-UC-024-ext-g-calibrate @extension @ext-g @error @artifact-required @pending
  ...
  @T-UC-024-ext-g-validate @extension @ext-g @error @artifact-required @pending
  ...
  @T-UC-024-ext-h-below @extension @ext-h @error @sampling-rate-invalid @pending
  ...
  @T-UC-024-ext-h-above @extension @ext-h @error @sampling-rate-invalid @pending
  ...
  @T-UC-024-ext-i-zero @extension @ext-i @error @pagination-invalid @pending
  ...
  @T-UC-024-ext-i-exceeds @extension @ext-i @error @pagination-invalid @pending
  ...
  @T-UC-024-ext-i-negative @extension @ext-i @error @pagination-invalid @pending
  ...
  @T-UC-024-ext-i-cursor @extension @ext-i @error @pagination-cursor-invalid @pending
  ...
  @T-UC-024-inv-179-holds @invariant @BR-RULE-179 @pending
  ...
  @T-UC-024-inv-179-text-holds @invariant @BR-RULE-179 @pending
  ...
  @T-UC-024-inv-179-media-holds @invariant @BR-RULE-179 @pending
  ...
  @T-UC-024-inv-179-violated-property @invariant @BR-RULE-179 @error @pending
  ...
  @T-UC-024-inv-179-violated-artid @invariant @BR-RULE-179 @error @pending
  ...
  @T-UC-024-inv-179-violated-assets @invariant @BR-RULE-179 @error @pending
  ...
  @T-UC-024-inv-179-violated-text @invariant @BR-RULE-179 @error @pending
  ...
  @T-UC-024-inv-179-violated-url @invariant @BR-RULE-179 @error @pending
  ...
  @T-UC-024-inv-180-holds @invariant @BR-RULE-180 @pending
  ...
  @T-UC-024-inv-180-violated-empty @invariant @BR-RULE-180 @error @pending
  ...
  @T-UC-024-inv-180-violated-exceeds @invariant @BR-RULE-180 @error @pending
  ...
  @T-UC-024-inv-180-violated-noid @invariant @BR-RULE-180 @error @pending
  ...
  @T-UC-024-inv-180-violated-noart @invariant @BR-RULE-180 @error @pending
  ...
  @T-UC-024-inv-181-binary @invariant @BR-RULE-181 @pending
  ...
  @T-UC-024-inv-181-confidence @invariant @BR-RULE-181 @pending
  ...
  @T-UC-024-inv-181-features @invariant @BR-RULE-181 @pending
  ...
  @T-UC-024-inv-181-unevaluated @invariant @BR-RULE-181 @pending
  ...
  @T-UC-024-inv-182-followup @invariant @BR-RULE-182 @pending
  ...
  @T-UC-024-inv-182-different @invariant @BR-RULE-182 @pending
  ...
  @T-UC-024-inv-182-async @invariant @BR-RULE-182 @pending
  ...
  @T-UC-024-inv-182-violated @invariant @BR-RULE-182 @error @pending
  ...
  @T-UC-024-inv-183-default @invariant @BR-RULE-183 @pending
  ...
  @T-UC-024-inv-183-method @invariant @BR-RULE-183 @pending
  ...
  @T-UC-024-inv-183-info @invariant @BR-RULE-183 @pending
  ...
  @T-UC-024-inv-183-violated @invariant @BR-RULE-183 @error @pending
  ...
  @T-UC-024-inv-183-method-invalid @invariant @BR-RULE-183 @error @pending
  ...
  @T-UC-024-inv-184-default @invariant @BR-RULE-184 @pending
  ...
  @T-UC-024-inv-184-cursor @invariant @BR-RULE-184 @pending
  ...
  @T-UC-024-inv-184-violated @invariant @BR-RULE-184 @error @pending
  ...
  @T-UC-024-inv-184-cursor-violated @invariant @BR-RULE-184 @error @pending
  ...
  @T-UC-024-inv-185-present @invariant @BR-RULE-185 @pending
  ...
  @T-UC-024-inv-185-absent @invariant @BR-RULE-185 @pending
  ...
  @T-UC-024-inv-185-failures @invariant @BR-RULE-185 @pending
  ...
  @T-UC-024-inv-186-omitted @invariant @BR-RULE-186 @pending
  ...
  @T-UC-024-inv-186-specified @invariant @BR-RULE-186 @pending
  ...
  @T-UC-024-inv-186-violated @invariant @BR-RULE-186 @error @pending
  ...
  @T-UC-024-inv-187-true @invariant @BR-RULE-187 @pending
  ...
  @T-UC-024-inv-187-false @invariant @BR-RULE-187 @pending
  ...
  @T-UC-024-inv-187-summary @invariant @BR-RULE-187 @pending
  ...
  @T-UC-024-inv-188-present @invariant @BR-RULE-188 @pending
  ...
  @T-UC-024-inv-188-additive @invariant @BR-RULE-188 @pending
  ...
  @T-UC-024-inv-188-filtered @invariant @BR-RULE-188 @pending
  ...
  @T-UC-024-partition-artifact @partition @artifact @pending
  ...
  @T-UC-024-partition-records @partition @records @pending
  ...
  @T-UC-024-partition-sampling @partition @sampling @pending
  ...
  @T-UC-024-partition-pagination @partition @pagination @pending
  ...
  @T-UC-024-partition-verdict @partition @verdict @pending
  ...
  @T-UC-024-partition-local-verdict @partition @local_verdict @pending
  ...
  @T-UC-024-partition-feature-ids @partition @feature_ids @pending
  ...
  @T-UC-024-partition-include-passed @partition @include_passed @pending
  ...
  @T-UC-024-partition-summary @partition @summary @pending
  ...
  @T-UC-024-partition-dialogue @partition @dialogue @pending
  ...
  @T-UC-024-boundary-artifact @boundary @artifact @pending
  ...
  @T-UC-024-boundary-records @boundary @records @pending
  ...
  @T-UC-024-boundary-sampling @boundary @sampling @pending
  ...
  @T-UC-024-boundary-pagination @boundary @pagination @pending
  ...
  @T-UC-024-boundary-verdict @boundary @verdict @pending
  ...
  @T-UC-024-boundary-local-verdict @boundary @local_verdict @pending
  ...
  @T-UC-024-boundary-feature-ids @boundary @feature_ids @pending
  ...
  @T-UC-024-boundary-include-passed @boundary @include_passed @pending
  ...
  @T-UC-024-boundary-summary @boundary @summary @pending
  ...
  @T-UC-024-boundary-dialogue @boundary @dialogue @pending
