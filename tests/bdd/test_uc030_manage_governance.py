...
routed to the conftest ``_XFAIL_TAGS`` registry (keyed on their ``@T-UC-030-*`` tags)
with documented reasons. Step definitions come from
``tests.bdd.steps.domain.uc030_governance`` (+ shared generic steps).
