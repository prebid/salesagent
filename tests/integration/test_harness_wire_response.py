...
class TestWireResponseIsRealWire:
    ...
    # NestedModelSerializerMixin fix. MCP's authenticity is therefore checked
    # two other ways below: round-trip fidelity through the response type
    # (test_mcp_wire_round_trips_through_the_response_type) and key-set parity
    # with REST (test_mcp_wire_matches_rest_field_shape).
    ENVELOPE_MARKERS = {
