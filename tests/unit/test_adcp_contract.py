...
class TestAdCPContract:
    ...
    def test_create_media_buy_asap_start_time(self):
        ...
        if hasattr(request.start_time, "root"):  # noqa: rootmodel — library version drift; both shapes valid
    ...
    def test_create_media_buy_with_brand_and_brand_id(self):
        ...
        if hasattr(brand_id, "root"):  # noqa: rootmodel — library version drift; both shapes valid
            brand_id_val = brand_id.root
        else:
