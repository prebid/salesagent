...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1686 then_has_deliveries_field",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1181 then_has_metrics",
    "bdd/steps/domain/uc004_delivery.py:1200 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1245 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1780 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:1861 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:1887 then_packages_exclude_field",
