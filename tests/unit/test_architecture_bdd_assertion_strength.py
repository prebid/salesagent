...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc003_update_media_buy.py:755 then_implementation_date_null",
    "bdd/steps/domain/uc003_update_media_buy.py:765 then_implementation_date_not_null",
    "bdd/steps/domain/uc003_update_media_buy.py:884 then_response_has_sandbox",
    "bdd/steps/domain/uc004_delivery.py:1801 then_has_errors_field",
    "bdd/steps/domain/uc011_accounts.py:1105 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1124 then_response_is_success_variant",
    "bdd/steps/domain/uc011_accounts.py:1348 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:1688 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:420 then_accounts_array_count",
    "bdd/steps/domain/uc011_accounts.py:521 then_empty_accounts",
    "bdd/steps/domain/uc011_accounts.py:586 then_accounts_from_first_page",
    "bdd/steps/domain/uc011_accounts.py:668 then_response_outcome",
    "bdd/steps/domain/uc011_accounts.py:810 then_success_with_accounts",
    "bdd/steps/domain/uc019_query_media_buys.py:923 then_package_details",
}

_GETATTR_EXISTENCE_ALLOWLIST: set[str] = {
    # FIXME(salesagent-beq4): replace getattr existence check with value comparison
    "bdd/steps/domain/uc003_update_media_buy.py:738 then_response_has_buyer_ref",
    "bdd/steps/domain/uc011_accounts.py:1049 then_errors_array",
    "bdd/steps/domain/uc011_accounts.py:668 then_response_outcome",
    "bdd/steps/domain/uc019_query_media_buys.py:923 then_package_details",
}
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc002_create_media_buy.py:2123 then_creatives_assigned_to_packages",
    "bdd/steps/domain/uc002_nfr.py:184 then_protocol_audit_logged",
    "bdd/steps/domain/uc003_update_media_buy.py:815 then_affected_packages_present",
    "bdd/steps/domain/uc003_update_media_buy.py:849 then_affected_package_budget",
    "bdd/steps/domain/uc004_delivery.py:1073 then_has_metrics",
    "bdd/steps/domain/uc004_delivery.py:1092 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1137 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1244 then_only_status",
    "bdd/steps/domain/uc004_delivery.py:1487 then_log_auth_rejection",
    "bdd/steps/domain/uc004_delivery.py:1773 then_has_deliveries_field",
    "bdd/steps/domain/uc004_delivery.py:1896 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1915 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1935 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:2012 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:2032 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:2049 then_packages_exclude_field",
    "bdd/steps/domain/uc004_delivery.py:2062 then_geo_system",
    "bdd/steps/domain/uc004_delivery.py:2085 then_placement_sorted_fallback",
    "bdd/steps/domain/uc004_delivery.py:2110 then_placement_sorted",
    "bdd/steps/domain/uc011_accounts.py:1105 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1190 then_all_accounts_action",
    "bdd/steps/domain/uc011_accounts.py:1206 then_failed_has_errors",
    "bdd/steps/domain/uc011_accounts.py:1617 then_account_in_db",
    "bdd/steps/domain/uc011_accounts.py:1688 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:2175 then_no_production_accounts",
    "bdd/steps/domain/uc011_accounts.py:2288 then_governance_agents_stored",
    "bdd/steps/domain/uc011_accounts.py:444 then_accounts_are_agent_scoped",
    "bdd/steps/domain/uc011_accounts.py:487 then_other_statuses_excluded",
    "bdd/steps/domain/uc011_accounts.py:668 then_response_outcome",
    "bdd/steps/domain/uc011_accounts.py:908 then_all_accounts_echo_brand",
    "bdd/steps/domain/uc019_query_media_buys.py:1014 then_buyer_refs_for_correlation",
    "bdd/steps/domain/uc019_query_media_buys.py:1865 then_either_status_returned",
    "bdd/steps/domain/uc019_query_media_buys.py:1882 then_any_status_returned",
    "bdd/steps/domain/uc019_query_media_buys.py:923 then_package_details",
    "bdd/steps/domain/uc019_query_media_buys.py:973 then_creative_approval_state",
    "bdd/steps/domain/uc026_package_media_buy.py:1562 then_package_has_id",
    "bdd/steps/domain/uc026_package_media_buy.py:1648 then_package_default_formats",
    "bdd/steps/domain/uc026_package_media_buy.py:1715 then_package_formats_to_provide",
    "bdd/steps/domain/uc026_package_media_buy.py:1830 then_package_all_fields",
    "bdd/steps/domain/uc026_package_media_buy.py:2231 then_new_pkg_in_mb",
    "bdd/steps/domain/uc026_package_media_buy.py:2264 then_new_pkg_created",
    "bdd/steps/generic/then_media_buy.py:290 then_webhook_notification",
    "bdd/steps/generic/then_media_buy.py:714 then_response_has_success_fields",
    "bdd/steps/generic/then_media_buy.py:74 then_response_has_packages",
    "bdd/steps/generic/then_payload.py:77 then_has_referrals",
}
