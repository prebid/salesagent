...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1024 then_has_metrics",
    "bdd/steps/domain/uc004_delivery.py:1045 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1075 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1297 then_exponential_backoff",
    "bdd/steps/domain/uc004_delivery.py:1312 then_retry_with_backoff",
    "bdd/steps/domain/uc004_delivery.py:1587 then_packages_include_breakdown",
