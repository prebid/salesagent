...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1762 then_has_deliveries_field",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1201 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1246 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1844 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1872 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1893 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:1974 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:1993 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:2019 then_packages_exclude_field",
    "bdd/steps/domain/uc004_delivery.py:2038 then_geo_system",
    ...
    "bdd/steps/domain/uc011_accounts.py:764 then_response_outcome",
    "bdd/steps/domain/uc019_query_media_buys.py:1334 then_creative_approval_state",
    "bdd/steps/domain/uc019_query_media_buys.py:1375 then_buyer_refs_for_correlation",
    "bdd/steps/domain/uc019_query_media_buys.py:2180 then_either_status_returned",
    "bdd/steps/domain/uc019_query_media_buys.py:2197 then_any_status_returned",
    "bdd/steps/domain/uc019_query_media_buys.py:1284 then_package_details",
    "bdd/steps/domain/uc026_package_media_buy.py:1679 then_package_has_id",
    "bdd/steps/domain/uc026_package_media_buy.py:1765 then_package_default_formats",
    "bdd/steps/domain/uc026_package_media_buy.py:1832 then_package_formats_to_provide",
    "bdd/steps/domain/uc026_package_media_buy.py:1965 then_package_all_fields",
    "bdd/steps/domain/uc026_package_media_buy.py:2435 then_new_pkg_in_mb",
    "bdd/steps/domain/uc026_package_media_buy.py:2468 then_new_pkg_created",
