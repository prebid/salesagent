...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1933 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1961 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1982 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:2063 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:2082 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:2108 then_packages_exclude_field",
    "bdd/steps/domain/uc004_delivery.py:2127 then_geo_system",
    ...
    "bdd/steps/domain/uc026_package_media_buy.py:1722 then_package_default_formats",
    "bdd/steps/domain/uc026_package_media_buy.py:1769 then_package_formats_to_provide",
    "bdd/steps/domain/uc026_package_media_buy.py:1881 then_package_all_fields",
    "bdd/steps/domain/uc026_package_media_buy.py:2347 then_new_pkg_in_mb",
    "bdd/steps/domain/uc026_package_media_buy.py:2380 then_new_pkg_created",
