...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc011_accounts.py:1693 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1712 then_response_is_success_variant",
    "bdd/steps/domain/uc011_accounts.py:1970 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:2067 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:2439 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:729 then_accounts_array_count",
    "bdd/steps/domain/uc011_accounts.py:861 then_empty_accounts",
    "bdd/steps/domain/uc011_accounts.py:932 then_accounts_from_first_page",
    "bdd/steps/domain/uc011_accounts.py:1034 then_response_outcome",
    "bdd/steps/domain/uc011_accounts.py:1313 then_success_with_accounts",
}
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc011_accounts.py:1426 then_all_accounts_echo_brand",
    "bdd/steps/domain/uc011_accounts.py:1693 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1801 then_all_accounts_action",
    "bdd/steps/domain/uc011_accounts.py:1817 then_failed_has_errors",
    "bdd/steps/domain/uc011_accounts.py:1924 then_setup_has_url",
    "bdd/steps/domain/uc011_accounts.py:1970 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:2067 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:2357 then_account_in_db",
    "bdd/steps/domain/uc011_accounts.py:2439 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:2970 then_no_production_accounts",
    "bdd/steps/domain/uc011_accounts.py:3085 then_governance_agents_stored",
    "bdd/steps/domain/uc011_accounts.py:739 then_accounts_have_fields",
    "bdd/steps/domain/uc011_accounts.py:760 then_accounts_are_agent_scoped",
    "bdd/steps/domain/uc011_accounts.py:804 then_only_status",
    "bdd/steps/domain/uc011_accounts.py:822 then_other_statuses_excluded",
    "bdd/steps/domain/uc011_accounts.py:1034 then_response_outcome",
