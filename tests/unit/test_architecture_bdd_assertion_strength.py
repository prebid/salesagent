...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1858 then_has_errors_field",
    "bdd/steps/domain/uc011_accounts.py:1230 then_errors_array",
    "bdd/steps/domain/uc011_accounts.py:1303 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1322 then_response_is_success_variant",
    "bdd/steps/domain/uc011_accounts.py:1580 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:1677 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:2018 then_only_agent_a_deactivated",
    ...
    "bdd/steps/domain/uc011_accounts.py:937 then_success_with_accounts",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1538 then_log_auth_rejection",
    "bdd/steps/domain/uc004_delivery.py:1830 then_has_deliveries_field",
    "bdd/steps/domain/uc004_delivery.py:1953 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1972 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1992 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:2073 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:2093 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:2119 then_packages_exclude_field",
    "bdd/steps/domain/uc004_delivery.py:2138 then_geo_system",
    "bdd/steps/domain/uc004_delivery.py:2161 then_placement_sorted_fallback",
    "bdd/steps/domain/uc004_delivery.py:2186 then_placement_sorted",
    "bdd/steps/domain/uc011_accounts.py:1050 then_all_accounts_echo_brand",
    "bdd/steps/domain/uc011_accounts.py:1303 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1411 then_all_accounts_action",
    "bdd/steps/domain/uc011_accounts.py:1427 then_failed_has_errors",
    "bdd/steps/domain/uc011_accounts.py:1534 then_setup_has_url",
    "bdd/steps/domain/uc011_accounts.py:1580 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:1677 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:1937 then_account_in_db",
    "bdd/steps/domain/uc011_accounts.py:2018 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:2549 then_no_production_accounts",
    "bdd/steps/domain/uc011_accounts.py:2664 then_governance_agents_stored",
