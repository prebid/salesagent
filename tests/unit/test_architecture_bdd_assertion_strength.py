...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1823 then_has_deliveries_field",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1905 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1933 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1954 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:2035 then_packages_include_field",
    ...
    "bdd/steps/domain/uc004_delivery.py:2099 then_geo_system",
