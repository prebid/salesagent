...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc011_accounts.py:745 then_accounts_array_count",
    "bdd/steps/domain/uc011_accounts.py:877 then_empty_accounts",
    "bdd/steps/domain/uc011_accounts.py:948 then_accounts_from_first_page",
    "bdd/steps/domain/uc011_accounts.py:1050 then_response_outcome",
    "bdd/steps/domain/uc011_accounts.py:1329 then_success_with_accounts",
    "bdd/steps/domain/uc011_accounts.py:1709 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1728 then_response_is_success_variant",
    "bdd/steps/domain/uc011_accounts.py:1986 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:2083 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:2455 then_only_agent_a_deactivated",
}
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc011_accounts.py:755 then_accounts_have_fields",
    "bdd/steps/domain/uc011_accounts.py:776 then_accounts_are_agent_scoped",
    "bdd/steps/domain/uc011_accounts.py:820 then_only_status",
    "bdd/steps/domain/uc011_accounts.py:838 then_other_statuses_excluded",
    "bdd/steps/domain/uc011_accounts.py:1050 then_response_outcome",
    "bdd/steps/domain/uc011_accounts.py:1442 then_all_accounts_echo_brand",
    "bdd/steps/domain/uc011_accounts.py:1709 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1817 then_all_accounts_action",
    "bdd/steps/domain/uc011_accounts.py:1833 then_failed_has_errors",
    "bdd/steps/domain/uc011_accounts.py:1940 then_setup_has_url",
    "bdd/steps/domain/uc011_accounts.py:1986 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:2083 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:2373 then_account_in_db",
    "bdd/steps/domain/uc011_accounts.py:2455 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:2986 then_no_production_accounts",
    "bdd/steps/domain/uc011_accounts.py:3101 then_governance_agents_stored",
    ...
    "bdd/steps/generic/then_payload.py:182 then_format_assets",
    "bdd/steps/generic/then_payload.py:91 then_has_referrals",
    "bdd/steps/generic/then_payload.py:127 then_referral_fields",
}
