...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc011_accounts.py:1322 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1341 then_response_is_success_variant",
    "bdd/steps/domain/uc011_accounts.py:1599 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:1696 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:2037 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:471 then_accounts_array_count",
    "bdd/steps/domain/uc011_accounts.py:603 then_empty_accounts",
    "bdd/steps/domain/uc011_accounts.py:674 then_accounts_from_first_page",
    "bdd/steps/domain/uc011_accounts.py:776 then_response_outcome",
    "bdd/steps/domain/uc011_accounts.py:942 then_success_with_accounts",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1218 then_has_metrics",
    "bdd/steps/domain/uc004_delivery.py:1237 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1282 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1975 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:2003 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:2024 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:2105 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:2124 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:2150 then_packages_exclude_field",
    "bdd/steps/domain/uc004_delivery.py:2169 then_geo_system",
    "bdd/steps/domain/uc011_accounts.py:1055 then_all_accounts_echo_brand",
    "bdd/steps/domain/uc011_accounts.py:1322 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1430 then_all_accounts_action",
    "bdd/steps/domain/uc011_accounts.py:1446 then_failed_has_errors",
    "bdd/steps/domain/uc011_accounts.py:1553 then_setup_has_url",
    "bdd/steps/domain/uc011_accounts.py:1599 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:1696 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:1956 then_account_in_db",
    "bdd/steps/domain/uc011_accounts.py:2037 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:2569 then_no_production_accounts",
    "bdd/steps/domain/uc011_accounts.py:2685 then_governance_agents_stored",
    "bdd/steps/domain/uc011_accounts.py:481 then_accounts_have_fields",
    "bdd/steps/domain/uc011_accounts.py:502 then_accounts_are_agent_scoped",
    "bdd/steps/domain/uc011_accounts.py:546 then_only_status",
    "bdd/steps/domain/uc011_accounts.py:564 then_other_statuses_excluded",
    "bdd/steps/domain/uc011_accounts.py:776 then_response_outcome",
    ...
    "bdd/steps/domain/uc019_query_media_buys.py:1305 then_package_details",
    "bdd/steps/domain/uc026_package_media_buy.py:1684 then_package_has_id",
    "bdd/steps/domain/uc026_package_media_buy.py:1727 then_package_default_formats",
    "bdd/steps/domain/uc026_package_media_buy.py:1758 then_package_formats_to_provide",
    "bdd/steps/domain/uc026_package_media_buy.py:1870 then_package_all_fields",
    "bdd/steps/domain/uc026_package_media_buy.py:2330 then_new_pkg_in_mb",
    "bdd/steps/domain/uc026_package_media_buy.py:2363 then_new_pkg_created",
