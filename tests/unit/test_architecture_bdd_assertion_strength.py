...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1857 then_has_errors_field",
    "bdd/steps/domain/uc011_accounts.py:1219 then_errors_array",
    "bdd/steps/domain/uc011_accounts.py:1292 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1311 then_response_is_success_variant",
    "bdd/steps/domain/uc011_accounts.py:1569 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:1666 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:2007 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:466 then_accounts_array_count",
    "bdd/steps/domain/uc011_accounts.py:598 then_empty_accounts",
    "bdd/steps/domain/uc011_accounts.py:669 then_accounts_from_first_page",
    "bdd/steps/domain/uc011_accounts.py:771 then_response_outcome",
    "bdd/steps/domain/uc011_accounts.py:926 then_success_with_accounts",
    "bdd/steps/domain/uc019_query_media_buys.py:1033 then_package_details",
}
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1131 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1176 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1283 then_only_status",
    "bdd/steps/domain/uc004_delivery.py:1537 then_log_auth_rejection",
    "bdd/steps/domain/uc004_delivery.py:1829 then_has_deliveries_field",
    "bdd/steps/domain/uc004_delivery.py:1952 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1971 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1991 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:2072 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:2092 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:2118 then_packages_exclude_field",
    "bdd/steps/domain/uc004_delivery.py:2137 then_geo_system",
    "bdd/steps/domain/uc004_delivery.py:2160 then_placement_sorted_fallback",
    "bdd/steps/domain/uc004_delivery.py:2185 then_placement_sorted",
    "bdd/steps/domain/uc011_accounts.py:1039 then_all_accounts_echo_brand",
    "bdd/steps/domain/uc011_accounts.py:1292 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1400 then_all_accounts_action",
    "bdd/steps/domain/uc011_accounts.py:1416 then_failed_has_errors",
    "bdd/steps/domain/uc011_accounts.py:1523 then_setup_has_url",
    "bdd/steps/domain/uc011_accounts.py:1569 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:1666 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:1926 then_account_in_db",
    "bdd/steps/domain/uc011_accounts.py:2007 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:2538 then_no_production_accounts",
    "bdd/steps/domain/uc011_accounts.py:2653 then_governance_agents_stored",
    "bdd/steps/domain/uc011_accounts.py:476 then_accounts_have_fields",
    "bdd/steps/domain/uc011_accounts.py:497 then_accounts_are_agent_scoped",
    "bdd/steps/domain/uc011_accounts.py:541 then_only_status",
    "bdd/steps/domain/uc011_accounts.py:559 then_other_statuses_excluded",
    "bdd/steps/domain/uc011_accounts.py:771 then_response_outcome",
    "bdd/steps/domain/uc019_query_media_buys.py:1083 then_creative_approval_state",
    "bdd/steps/domain/uc019_query_media_buys.py:1124 then_buyer_refs_for_correlation",
    "bdd/steps/domain/uc019_query_media_buys.py:1933 then_either_status_returned",
    "bdd/steps/domain/uc019_query_media_buys.py:1950 then_any_status_returned",
    "bdd/steps/domain/uc019_query_media_buys.py:1033 then_package_details",
    "bdd/steps/domain/uc026_package_media_buy.py:1653 then_package_has_id",
    "bdd/steps/domain/uc026_package_media_buy.py:1739 then_package_default_formats",
    "bdd/steps/domain/uc026_package_media_buy.py:1806 then_package_formats_to_provide",
    "bdd/steps/domain/uc026_package_media_buy.py:1939 then_package_all_fields",
    "bdd/steps/domain/uc026_package_media_buy.py:2403 then_new_pkg_in_mb",
    "bdd/steps/domain/uc026_package_media_buy.py:2436 then_new_pkg_created",
