...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc003_update_media_buy.py:792 then_implementation_date_null",
    ...
    "bdd/steps/domain/uc004_delivery.py:1480 then_has_deliveries_field",
    "bdd/steps/domain/uc003_update_media_buy.py:802 then_implementation_date_not_null",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc011_accounts.py:588 then_accounts_from_first_page",
    "bdd/steps/generic/then_payload.py:77 then_only_image_assets",
    "bdd/steps/domain/uc004_delivery.py:1643 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:1630 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:1598 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:1571 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1296 then_retry_with_backoff",
    "bdd/steps/domain/uc004_delivery.py:1281 then_exponential_backoff",
    "bdd/steps/domain/uc004_delivery.py:1059 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1029 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1008 then_has_metrics",
    ...
    "bdd/steps/generic/then_payload.py:95 then_has_referrals",
}
