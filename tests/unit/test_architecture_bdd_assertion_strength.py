...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1929 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1957 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1978 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:2059 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:2078 then_packages_include_two",
