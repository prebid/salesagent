...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1723 then_has_deliveries_field",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1805 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1833 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1854 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:1935 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:1954 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:1980 then_packages_exclude_field",
    "bdd/steps/domain/uc004_delivery.py:1999 then_geo_system",
