...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc026_package_media_buy.py:1902 then_package_all_fields",
    "bdd/steps/domain/uc026_package_media_buy.py:2368 then_new_pkg_in_mb",
    "bdd/steps/domain/uc026_package_media_buy.py:2401 then_new_pkg_created",
