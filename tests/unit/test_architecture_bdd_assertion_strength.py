...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1491 then_has_deliveries_field",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1019 then_has_metrics",
    "bdd/steps/domain/uc004_delivery.py:1040 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1070 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1292 then_exponential_backoff",
    "bdd/steps/domain/uc004_delivery.py:1307 then_retry_with_backoff",
    "bdd/steps/domain/uc004_delivery.py:1582 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1609 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:1641 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:1654 then_packages_include_two",
