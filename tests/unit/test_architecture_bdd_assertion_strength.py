...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc026_package_media_buy.py:1876 then_package_all_fields",
    "bdd/steps/domain/uc026_package_media_buy.py:2336 then_new_pkg_in_mb",
    "bdd/steps/domain/uc026_package_media_buy.py:2369 then_new_pkg_created",
