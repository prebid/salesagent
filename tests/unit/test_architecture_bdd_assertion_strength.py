...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc011_accounts.py:1724 then_response_is_success_variant",
    "bdd/steps/domain/uc011_accounts.py:1982 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:2079 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:2451 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:741 then_accounts_array_count",
    "bdd/steps/domain/uc011_accounts.py:873 then_empty_accounts",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc011_accounts.py:1829 then_failed_has_errors",
    "bdd/steps/domain/uc011_accounts.py:1936 then_setup_has_url",
    "bdd/steps/domain/uc011_accounts.py:1982 then_webhook_registered",
    "bdd/steps/domain/uc011_accounts.py:2079 then_push_sent",
    "bdd/steps/domain/uc011_accounts.py:2369 then_account_in_db",
    "bdd/steps/domain/uc011_accounts.py:2451 then_only_agent_a_deactivated",
    "bdd/steps/domain/uc011_accounts.py:2983 then_no_production_accounts",
    "bdd/steps/domain/uc011_accounts.py:3099 then_governance_agents_stored",
    "bdd/steps/domain/uc011_accounts.py:751 then_accounts_have_fields",
