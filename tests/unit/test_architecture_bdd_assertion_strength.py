...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1687 then_has_deliveries_field",
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1769 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1797 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:1818 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:1899 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:1918 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:1944 then_packages_exclude_field",
    "bdd/steps/domain/uc004_delivery.py:1963 then_geo_system",
