...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc019_query_media_buys.py:1302 then_package_details",
}
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc004_delivery.py:1217 then_has_metrics",
    "bdd/steps/domain/uc004_delivery.py:1236 then_has_packages",
    "bdd/steps/domain/uc004_delivery.py:1281 then_has_mb_status",
    "bdd/steps/domain/uc004_delivery.py:1974 then_packages_include_breakdown",
    "bdd/steps/domain/uc004_delivery.py:2002 then_packages_exclude_breakdown",
    "bdd/steps/domain/uc004_delivery.py:2023 then_packages_limited",
    "bdd/steps/domain/uc004_delivery.py:2104 then_packages_include_field",
    "bdd/steps/domain/uc004_delivery.py:2123 then_packages_include_two",
    "bdd/steps/domain/uc004_delivery.py:2149 then_packages_exclude_field",
    "bdd/steps/domain/uc004_delivery.py:2168 then_geo_system",
    ...
    "bdd/steps/domain/uc011_accounts.py:764 then_response_outcome",
    "bdd/steps/domain/uc019_query_media_buys.py:1352 then_creative_approval_state",
    "bdd/steps/domain/uc019_query_media_buys.py:1393 then_buyer_refs_for_correlation",
    "bdd/steps/domain/uc019_query_media_buys.py:2198 then_either_status_returned",
    "bdd/steps/domain/uc019_query_media_buys.py:2215 then_any_status_returned",
    "bdd/steps/domain/uc019_query_media_buys.py:1302 then_package_details",
