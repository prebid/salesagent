...
# FIXME(salesagent-hr8n): 4 violations remain (20 fixed by auto-serialization in update_workflow_step).
KNOWN_VIOLATIONS = {
    # _update_media_buy_impl: 2 violations (composite approval dict — needs further refactoring)
