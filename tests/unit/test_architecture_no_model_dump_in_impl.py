...
KNOWN_VIOLATIONS = {
    ...
    # Line numbers updated after salesagent-ljz0 added the state-machine
    # precondition guard to _update_media_buy_impl.
    ("media_buy_update.py", 263),
    ("media_buy_update.py", 323),
    ("media_buy_update.py", 324),
    ("media_buy_update.py", 378),
    ("media_buy_update.py", 435),
    ...
    ("media_buy_update.py", 648),
    ("media_buy_update.py", 674),
    ("media_buy_update.py", 853),
    ("media_buy_update.py", 884),
    ("media_buy_update.py", 912),
    ("media_buy_update.py", 1083),
    ("media_buy_update.py", 1101),
    ("media_buy_update.py", 1151),
    ("media_buy_update.py", 1244),
    ("media_buy_update.py", 1276),
    ("media_buy_update.py", 1339),
