...
KNOWN_VIOLATIONS = {
    ...
    ("media_buy_update.py", 305),
    ("media_buy_update.py", 409),
    ("media_buy_update.py", 410),
    ("media_buy_update.py", 467),
    ("media_buy_update.py", 524),
    ("media_buy_update.py", 547),
    ("media_buy_update.py", 590),
    ("media_buy_update.py", 619),
    ("media_buy_update.py", 636),
    ("media_buy_update.py", 692),
    ("media_buy_update.py", 722),
    ("media_buy_update.py", 739),
    ("media_buy_update.py", 765),
    ("media_buy_update.py", 943),
    ("media_buy_update.py", 972),
    ("media_buy_update.py", 1002),
    ("media_buy_update.py", 1174),
    ("media_buy_update.py", 1192),
    ("media_buy_update.py", 1245),
    ("media_buy_update.py", 1338),
    ("media_buy_update.py", 1372),
    ("media_buy_update.py", 1434),
