...
KNOWN_VIOLATIONS = {
    ...
    ("media_buy_update.py", 732),
    ("media_buy_update.py", 758),
    ("media_buy_update.py", 937),
    ("media_buy_update.py", 968),
    ("media_buy_update.py", 996),
    ("media_buy_update.py", 1167),
    ("media_buy_update.py", 1185),
    ("media_buy_update.py", 1238),
    ("media_buy_update.py", 1331),
    ("media_buy_update.py", 1363),
    ("media_buy_update.py", 1427),
