...
ALLOWLIST: set[tuple[str, str]] = {
    ...
    ("src/admin/blueprints/tmp_providers_bp.py", "add_tmp_provider"),  # select(Tenant) — no tenant repo yet
    ("src/admin/blueprints/tmp_providers_bp.py", "edit_tmp_provider"),  # select(Tenant) — no tenant repo yet
    ("src/admin/blueprints/tmp_providers_bp.py", "list_tmp_providers"),  # select(Tenant) — no tenant repo yet
