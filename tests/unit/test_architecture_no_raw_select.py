...
ALLOWLIST: set[tuple[str, str]] = {
    ...
    ("src/admin/sync_api.py", "get_tenant_management_api_key"),
    ...
    ("src/admin/tenant_management_api.py", "decorated_function"),
    ("src/admin/tenant_management_api.py", "delete_tenant"),
    ("src/admin/tenant_management_api.py", "get_tenant"),
    ("src/admin/tenant_management_api.py", "initialize_api_key"),
    ("src/admin/tenant_management_api.py", "require_tenant_management_api_key"),
