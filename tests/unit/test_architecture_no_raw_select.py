...
ALLOWLIST: set[tuple[str, str]] = {
    ...
    ("src/admin/routers/adapters.py", "mock_config"),
    ("src/admin/routers/adapters.py", "save_adapter_config"),
    ("src/admin/routers/api.py", "get_tenant_products"),
    ("src/admin/routers/auth.py", "gam_authorize"),
    ("src/admin/routers/auth.py", "gam_callback"),
    ("src/admin/routers/auth.py", "google_callback"),
    ("src/admin/routers/auth.py", "login"),
    ("src/admin/routers/auth.py", "logout"),
    ("src/admin/routers/auth.py", "tenant_login"),
    ("src/admin/routers/auth.py", "test_auth"),
    ("src/admin/routers/authorized_properties.py", "_construct_agent_url"),
    ("src/admin/routers/authorized_properties.py", "_save_properties_batch"),
    ("src/admin/routers/authorized_properties.py", "create_property"),
    ("src/admin/routers/authorized_properties.py", "create_property_tag"),
    ("src/admin/routers/authorized_properties.py", "delete_property"),
    ("src/admin/routers/authorized_properties.py", "edit_property"),
    ("src/admin/routers/authorized_properties.py", "list_authorized_properties"),
    ("src/admin/routers/authorized_properties.py", "list_authorized_properties_api"),
    ("src/admin/routers/authorized_properties.py", "list_property_tags"),
    ("src/admin/routers/authorized_properties.py", "sync_properties_from_adagents"),
    ("src/admin/routers/authorized_properties.py", "upload_authorized_properties"),
    ("src/admin/routers/core.py", "create_tenant"),
    ("src/admin/routers/core.py", "get_tenant_from_hostname"),
    ("src/admin/routers/core.py", "index"),
    ("src/admin/routers/core.py", "reactivate_tenant"),
    ("src/admin/routers/core.py", "render_super_admin_index"),
    ("src/admin/routers/creative_agents.py", "add_creative_agent"),
    ("src/admin/routers/creative_agents.py", "delete_creative_agent"),
    ("src/admin/routers/creative_agents.py", "edit_creative_agent"),
    ("src/admin/routers/creative_agents.py", "list_creative_agents"),
    ("src/admin/routers/creative_agents.py", "test_creative_agent"),
    ("src/admin/routers/gam.py", "configure_gam"),
    ("src/admin/routers/gam.py", "get_gam_custom_targeting_keys"),
    ("src/admin/routers/gam.py", "get_gam_line_item_api"),
    ("src/admin/routers/gam.py", "get_latest_sync_status"),
    ("src/admin/routers/gam.py", "get_sync_status"),
    ("src/admin/routers/gam.py", "reset_stuck_sync"),
    ("src/admin/routers/gam.py", "test_gam_connection"),
    ("src/admin/routers/gam.py", "view_gam_line_item"),
    ("src/admin/routers/inventory.py", "analyze_ad_server_inventory"),
    ("src/admin/routers/inventory.py", "check_inventory_sync"),
    ("src/admin/routers/inventory.py", "get_inventory_list"),
    ("src/admin/routers/inventory.py", "get_inventory_sizes"),
    ("src/admin/routers/inventory.py", "get_inventory_tree"),
    ("src/admin/routers/inventory.py", "get_order_details"),
    ("src/admin/routers/inventory.py", "get_orders"),
    ("src/admin/routers/inventory.py", "get_sync_status"),
    ("src/admin/routers/inventory.py", "get_targeting_data"),
    ("src/admin/routers/inventory.py", "get_targeting_values"),
    ("src/admin/routers/inventory.py", "inventory_browser"),
    ("src/admin/routers/inventory.py", "orders_browser"),
    ("src/admin/routers/inventory.py", "sync_inventory"),
    ("src/admin/routers/inventory.py", "sync_orders"),
    ("src/admin/routers/inventory.py", "targeting_browser"),
    ("src/admin/routers/inventory_profiles.py", "add_inventory_profile"),
    ("src/admin/routers/inventory_profiles.py", "edit_inventory_profile"),
    ("src/admin/routers/inventory_profiles.py", "list_inventory_profiles"),
    ("src/admin/routers/inventory_profiles.py", "list_inventory_profiles_api"),
    ("src/admin/routers/oidc.py", "callback"),
    ("src/admin/routers/oidc.py", "enable"),
    ("src/admin/routers/oidc.py", "login"),
    ("src/admin/routers/oidc.py", "test_initiate"),
    ("src/admin/routers/operations.py", "approve_media_buy"),
    ("src/admin/routers/operations.py", "media_buy_detail"),
    ("src/admin/routers/operations.py", "reporting"),
    ("src/admin/routers/policy.py", "index"),
    ("src/admin/routers/policy.py", "review_task"),
    ("src/admin/routers/policy.py", "update"),
    ("src/admin/routers/principals.py", "create_principal"),
    ("src/admin/routers/principals.py", "delete_principal"),
    ("src/admin/routers/principals.py", "delete_webhook"),
    ("src/admin/routers/principals.py", "edit_principal"),
    ("src/admin/routers/principals.py", "get_gam_advertisers"),
    ("src/admin/routers/principals.py", "get_principal"),
    ("src/admin/routers/principals.py", "get_principal_config"),
    ("src/admin/routers/principals.py", "list_principals"),
    ("src/admin/routers/principals.py", "manage_webhooks"),
    ("src/admin/routers/principals.py", "register_webhook"),
    ("src/admin/routers/principals.py", "save_testing_config"),
    ("src/admin/routers/principals.py", "toggle_webhook"),
    ("src/admin/routers/principals.py", "update_mappings"),
    ("src/admin/routers/products.py", "_render_add_product_form"),
    ("src/admin/routers/products.py", "add_product"),
    ("src/admin/routers/products.py", "assign_inventory_to_product"),
    ("src/admin/routers/products.py", "delete_product"),
    ("src/admin/routers/products.py", "edit_product"),
    ("src/admin/routers/products.py", "get_product_inventory"),
    ("src/admin/routers/products.py", "list_products"),
    ("src/admin/routers/products.py", "unassign_inventory_from_product"),
    ("src/admin/routers/public.py", "landing"),
    ("src/admin/routers/public.py", "provision_tenant"),
    ("src/admin/routers/public.py", "signup_complete"),
    ("src/admin/routers/publisher_partners.py", "add_publisher_partner"),
    ("src/admin/routers/publisher_partners.py", "delete_publisher_partner"),
    ("src/admin/routers/publisher_partners.py", "get_publisher_properties"),
    ("src/admin/routers/publisher_partners.py", "list_publisher_partners"),
    ("src/admin/routers/publisher_partners.py", "sync_publisher_partners"),
    ("src/admin/routers/settings.py", "get_approximated_token"),
    ("src/admin/routers/settings.py", "register_approximated_domain"),
    ("src/admin/routers/settings.py", "test_ai_connection"),
    ("src/admin/routers/settings.py", "update_adapter"),
    ("src/admin/routers/settings.py", "update_ai"),
    ("src/admin/routers/settings.py", "update_business_rules"),
    ("src/admin/routers/settings.py", "update_general"),
    ("src/admin/routers/settings.py", "update_slack"),
    ("src/admin/routers/signals_agents.py", "add_signals_agent"),
    ("src/admin/routers/signals_agents.py", "delete_signals_agent"),
    ("src/admin/routers/signals_agents.py", "edit_signals_agent"),
    ("src/admin/routers/signals_agents.py", "list_signals_agents"),
    ("src/admin/routers/signals_agents.py", "test_signals_agent"),
    ("src/admin/routers/tenants.py", "deactivate_tenant"),
    ("src/admin/routers/tenants.py", "media_buys_list"),
    ("src/admin/routers/tenants.py", "remove_favicon"),
    ("src/admin/routers/tenants.py", "setup_checklist"),
    ("src/admin/routers/tenants.py", "tenant_settings"),
    ("src/admin/routers/tenants.py", "test_slack"),
    ("src/admin/routers/tenants.py", "update"),
    ("src/admin/routers/tenants.py", "update_favicon_url"),
    ("src/admin/routers/tenants.py", "update_slack"),
    ("src/admin/routers/tenants.py", "upload_favicon"),
    ("src/admin/routers/users.py", "add_domain"),
    ("src/admin/routers/users.py", "add_user"),
    ("src/admin/routers/users.py", "disable_setup_mode"),
    ("src/admin/routers/users.py", "enable_setup_mode"),
    ("src/admin/routers/users.py", "list_users"),
    ("src/admin/routers/users.py", "remove_domain"),
    ("src/admin/routers/users.py", "toggle_user"),
    ("src/admin/routers/users.py", "update_role"),
    ("src/admin/routers/workflows.py", "approve_workflow_step"),  # select(CreativeAssignment) — no creative repo yet
    ("src/admin/routers/workflows.py", "list_workflows"),  # select(Tenant) — no tenant repo yet
    ("src/admin/routers/workflows.py", "review_workflow_step"),  # select(Context) — context lookup
