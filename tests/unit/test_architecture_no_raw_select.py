...
ALLOWLIST: set[tuple[str, str]] = {
    ...
    ("src/admin/blueprints/tmp_providers_bp.py", "add_tmp_provider"),
    ("src/admin/blueprints/tmp_providers_bp.py", "deactivate_tmp_provider"),
    ("src/admin/blueprints/tmp_providers_bp.py", "delete_tmp_provider"),
    ("src/admin/blueprints/tmp_providers_bp.py", "edit_tmp_provider"),
    ("src/admin/blueprints/tmp_providers_bp.py", "health_check_tmp_provider"),
    ("src/admin/blueprints/tmp_providers_bp.py", "list_tmp_providers"),
